...
class _EditTicketDetail2 extends State<EditTicketDetail2> {
  String _camion_fecha_llegada,_camion_hora_llegada,_hora_fin_carga,_fecha_fin_carga,_hora_lelgada, _estiba_hora_llegada, _ases_fecha_llegada,
      _ases_hora_llegada,_ases_codigo, _fecha_ini_carga, _hora_ini_carga;
                                          ...
                                          DateTimeField(
                                            ...
                                            onDateSelected: (DateTime date) {
                                              setState(() {
                                                ...
                                                _camion_hora_llegada= formattedTime;
                                              });
                                            },
                                          ),
                                          SizedBox(
                                          ...
                                          Container(
                                            ...
                                            child: FlatButton(
                                              ...
                                              onPressed: () async {
                                                print(_ases_codigo);
                                                final Tottus = {
                                                  TottusFields.CamionFechaLlegada: _camion_fecha_llegada,
                                                  TottusFields.CamionHoraCita: _camion_hora_llegada,
                                                  TottusFields.EstibaHoraLlegada: _estiba_hora_llegada,
                                                  TottusFields.CodigoAsesor: _ases_codigo,
                                                  TottusFields.AsesoriaFechaLlegada: _ases_fecha_llegada,
                                                  TottusFields.AsesoriaHorallegada: _ases_hora_llegada,
                                                  TottusFields.FechaInicioDeCarga: _fecha_ini_carga,
                                                  TottusFields.HoraInicioDeCarga: _hora_ini_carga,
                                                  TottusFields.FechaFinDeCarga: _fecha_fin_carga,
                                                  TottusFields.HoraFinDeCarga: _hora_fin_carga,

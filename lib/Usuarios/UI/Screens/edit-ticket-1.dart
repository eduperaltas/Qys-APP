                                  ...
                                  children: <Widget>[
                                    ...
                                    Container(
                                      ...
                                      child: FlatButton(
                                        ...
                                        onPressed: () async {
                                          final Tottus = {
                                            TottusFields.Tiendanum: carga.tit_nombre + carga.tit_num,
                                            TottusFields.NumeroTim: _numTim,
                                            TottusFields.FechaProgramacion: _fecha_programacion,
                                            TottusFields.EmpresadeTransporte: _empresa_transporte,
                                            TottusFields.Origen: _origen,
                                            TottusFields.Destino: _destino,
                                            TottusFields.TipodeCarga: _tipo_carga,
                                            TottusFields.PlacaCarreta: _placa_carretera,
                                            TottusFields.Rampa: _rampa,
                                            TottusFields.EquipodeCarga: _equipo_carga,
                                            TottusFields.CamionFechaCita: _cam_fecha_cita,
                                            TottusFields.CamionHoraCita: _cam_hora_cita,
                                          };
